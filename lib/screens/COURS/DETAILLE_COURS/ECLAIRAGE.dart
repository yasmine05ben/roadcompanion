...
class EclairageScreen extends StatefulWidget {
  @override
  _EclairageScreenState createState() => _EclairageScreenState();
}
...
class _EclairageScreenState extends State<EclairageScreen> {
  ...
  Future<void> fetchData() async {
    final box = await Hive.openBox('lightsBox');

    try {
      final paragraphResponse =
      await http.get(Uri.parse('${Config.baseUrl}/lights/paragraphes'));
      final imageResponse =
      await http.get(Uri.parse('${Config.baseUrl}/lights/images'));
