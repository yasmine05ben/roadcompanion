...
class IntroductionScreenPROB extends StatefulWidget {
  @override
  _IntroductionScreenPROBState createState() => _IntroductionScreenPROBState();
}

class _IntroductionScreenPROBState extends State<IntroductionScreenPROB> {
  String? category;
  String? explanation;
  bool isLoading = true;
  bool hasError = false;
  ...
  Future<void> fetchIntroductionData() async {
    final box = await Hive.openBox('panneauxRoutesInterdictionBox');

    try {
      final response = await http.get(Uri.parse('${Config.baseUrl}/panneauxRoutes/explication/interdiction'));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [ SizedBox(height: 20),
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SignListScreen2()));
                },
