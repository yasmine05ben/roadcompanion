...
import 'DTDANGER.dart';
import '/config.dart';
import 'package:hive/hive.dart';
class IntroductionScreenDANGER extends StatefulWidget {
  @override
  _IntroductionScreenDANGERState createState() => _IntroductionScreenDANGERState();
}

class _IntroductionScreenDANGERState extends State<IntroductionScreenDANGER> {
  String? category;
  String? explanation;
  bool isLoading = true;
  bool hasError = false;
  ...
  Future<void> fetchIntroductionData() async {
    ...
    try {
      final response = await http.get(Uri.parse('${Config.baseUrl}/panneauxRoutes/explication/danger'));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [  SizedBox(height: 20),
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SignListScreen3()));
                },
