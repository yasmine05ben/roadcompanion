...
class VitesseScreen extends StatefulWidget {
  @override
  _VitesseScreenState createState() => _VitesseScreenState();
}

class _VitesseScreenState extends State<VitesseScreen> {
  ...
  Future<void> fetchData() async {
    final box = await Hive.openBox('vitessesBox');

    try {
      final paragraphResponse =
      await http.get(Uri.parse('${Config.baseUrl}/vitesses/paragraphes'));
      final imageResponse =
      await http.get(Uri.parse('${Config.baseUrl}/vitesses/images'));
