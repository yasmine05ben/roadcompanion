...
import 'mecanicrqst.dart';

class AssuranceQuestionPage extends StatelessWidget {
  const AssuranceQuestionPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 15),
                  const Text(
                    "نحن هنا لمساعدتك في حالات الأعطال أو الحوادث. سواء كنت تملك تأمينًا يغطي هذه الخدمة أو لا، نوفر لك حلولاً فورية وسريعة لسحب أو إصلاح سيارتك.",
                    style: TextStyle(
                      fontSize: 18,
                      fontFamily: 'Cairo',
            ...
            // Benefits section
            // In your build method, replace the existing benefits section with this:
                ...
                child: Column(
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      child: const Icon(Icons.car_crash_outlined, size: 50, color: Color(0xFF277DA1)),
                    ),
                    const SizedBox(height: 20),
                    const Text(
                      "هل تمتلك تأمينًا ساريًا على سيارتك يمكننا استخدامه لتقديم الخدمة؟",
                      style: TextStyle(
                        fontSize: 20,
                    ...
                    // No button with pulse animation
                    AnimatedContainer(
