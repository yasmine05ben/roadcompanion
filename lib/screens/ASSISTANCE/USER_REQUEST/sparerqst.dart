...
class Normal2UserScreen extends StatefulWidget {
  @override
  _Normal2UserScreenState createState() => _Normal2UserScreenState();
}

class _Normal2UserScreenState extends State<Normal2UserScreen> {
  ...
  final TextEditingController _carTypeController = TextEditingController(); // NEW
  final TextEditingController _pieceNameController = TextEditingController(); // NEW
  ...
  Future<void> _sendRequest() async {
    ...
    _channel?.sink.add(jsonEncode({
      'type': 'new_request',
      'userId': userId,
      'serviceType': "بائع قطع الغيار",
      'lat': userLocation!.latitude,
      'lng': userLocation!.longitude,
      'requestId': requestId,
      'carModel': _carTypeController.text.trim(),  // NEW
      'pieceName': _pieceNameController.text.trim(), // NEW
    }));
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Directionality(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.directions_car, color: mainColor),
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                    ),
                  ),
                ),
                ...
                Directionality(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
                      hintText: 'اسم القطعة المطلوبة',
                      prefixIcon: Icon(Icons.build, color: mainColor),
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                    ),
                  ),
                ),
                ...
                ElevatedButton(
                  ...
                  child: Text("طلب قطع غيار", style: TextStyle(color: Colors.white)),
                ),
